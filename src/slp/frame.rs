...
///
/// Commands 0x01, 0x06, 0x07, 0x0A, 0x0B store the number of pixels either in
/// the command itself or in the next byte. If `cmd >> n` is not 0, this value
/// is used. Otherwise, the next byte is used.
///
/// # Arguments
///
